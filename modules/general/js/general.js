...
{
	this.mi = window.maxFoundry.maxInbound;
	...
	$(document).on('mib_ajax_success_flushtransients', $.proxy(this.successHandlerEvent, this ) ); 
...
miGeneral.prototype.reload = function ()
{
	
}

miGeneral.prototype.dialog = function () 
{
